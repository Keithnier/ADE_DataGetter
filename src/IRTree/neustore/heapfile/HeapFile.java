package IRTree.neustore.heapfile;
...
public class HeapFile extends DBIndex {
     ...
     */
    protected long firstFullPageID;
    /**
     * pageID of the first non-full page. -1 if none.
     */
    protected long firstNonFullPageID;
     ...
     * @throws IOException
     */
    protected HeapFilePage myReadPage(long pageID ) throws IOException {
     ...
     * @throws IOException
     */
    protected void removePageFromList( long pageID, HeapFilePage page )
    throws IOException {
     ...
     * @throws IOException
     */
    protected void addPageToFullList( long pageID, HeapFilePage page )
    throws IOException {
    	page.prev = -1;
     ...
     * @throws IOException
     */
    protected void addPageToNonFullList( long pageID, HeapFilePage page )
    throws IOException {
    	page.prev = -1;
    ...
    public void insert(Key key, Data data ) throws IOException {
    	...
    	if ( firstNonFullPageID == -1 ) { 
    		...
    		if ( firstNonFullPage.isFull() ) {
    			long newFullPageID = firstNonFullPageID;
    ...
    protected void readIndexHead (byte[] indexHead) {
    	...
    	try {
			numRecs = ba.readInt();
			firstFullPageID = readLong(ba);
			firstNonFullPageID = readLong(ba);
		} catch (IOException e) {}
    }
    protected void writeIndexHead (byte[] indexHead) {
    	...
    	try {
    		ba.writeInt(numRecs);
    		ba.writeLong(firstFullPageID);
    		ba.writeLong(firstNonFullPageID);
		} catch (IOException e) {}
    }

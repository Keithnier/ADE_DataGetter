...
public abstract class DBBuffer {
	 ...
	 * @throws IOException
	 */
	protected void load (RandomAccessFile file, byte[] page, long pageID) throws IOException {
	 ...
	 * @throws IOException
	 */
	protected void save (RandomAccessFile file, byte[] page, long pageID) throws IOException {

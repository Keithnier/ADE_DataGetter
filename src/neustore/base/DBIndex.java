...
//				System.out.println("File exists! Can not create new file!"); System.exit(0);
			...
			numPages = readLong(ba);
			firstEmpty = readLong(ba);
	...
	public void close () throws IOException {
		...
		out.writeLong(numPages);
		out.writeLong(firstEmpty);
		out.write(indexHead);
	...
	protected long readLong(ByteArray ba)throws IOException{
		return ((long)(ba.readInt()) << 32) + (ba.readInt() & 0xFFFFFFFFL);  
	}

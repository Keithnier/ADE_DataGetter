...
<head>
    ...
    <script type="text/javascript">
        ...
        var initParam = {west_long:"-180", south_lat:"-90", east_long:"180", north_lat:"90", keyword:""};
        ...
        function start (){
            if (isGoing == false){
                ...
                initParam.keyword = keyword;

                var params = JSON.stringify(initParam);

                if ( keyword == "" || time == "")
                {
                    alert("Please fill in the keyword && time!");
                }else if(!(Twitter||Flickr||Tumblr||YouTube)){
                    alert("Please Choose the platform！");
                } else{
                    $.ajax({
                        url:"/DataGetServlet",//要请求的服务器url
                        data:{option:"start",time:time, keyword:keyword,Twitter:Twitter,Flickr:Flickr,Tumblr:Tumblr,YouTube:YouTube, crawlerType:"Keyword", params:params},  //要向服务器发送的数据
                        async:true,   //是否为异步请求
                        cache:false,  //是否缓存结果
                        type:"POST", //请求方式为POST
...
<aside >
    <ul class="menu">
        <li><img class="icon" src="../image/left/dataGet.png"><a href="bytime.jsp" onclick="return isStop()" >Crawl By Time</a></li>
        <li class="active"><img class="icon" src="../image/left/dataPreProcess.png"><a href="bykeyword.jsp" onclick="return isStop()">Crawl By Keyword</a></li>
    ...
    <section id="con">
        <div class="content">
            <div id="params"  style="display: block">
                ...
                <label title="Different platforms have different keyword search support. Please check it carefully.">Keyword:&nbsp;&nbsp;<input id="keyword" type="text" name="keyword" >&nbsp;&nbsp;&nbsp;&nbsp;</label>
            </div>
            <label>
                Platform：&nbsp;&nbsp;
                <input id="Twitter"  type="checkbox" value="Twitter"  title="Twitter supports multiple keywords. ',' for 'AND' relationships, '|' for 'OR' relationships."/>&nbsp;&nbsp;Twitter&nbsp;&nbsp;
                <input id="Flickr"  type="checkbox" value="Flickr"  title="Flickr supports text retrieval. It will find the relevant content containing the entire input."/>&nbsp;&nbsp;Flickr&nbsp;&nbsp;
                <input id="Tumblr"  type="checkbox" value="Tumblr"  title="Tumblr supports tag search and can only enter one keyword."/>&nbsp;&nbsp;Tumblr&nbsp;&nbsp;
                <input id="YouTube"  type="checkbox" value="YouTube" title="YouTube supports multiple keywords, | for 'OR', - for 'NOT'."/>&nbsp;&nbsp;YouTube&nbsp;&nbsp;
            </label>
        </div>
        <div class="content">
